...
export function LoginScreen({ redirectTo }: LoginScreenProps) {
  ...
  const submitDisabled = pending || !email.trim() || password.length === 0
          ...
          <Surface className="rounded-3xl border-white/10 bg-[rgb(11_20_34/0.78)] p-6 shadow-[0_24px_80px_rgb(0_0_0/0.34)] backdrop-blur-xl md:p-8">
            ...
            <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
              ...
              >
                <Input
                  autoComplete="email"
                  className="h-13 rounded-xl border-white/10! bg-white/6! text-white! shadow-none! placeholder:text-slate-400! hover:border-[#4d76c5]! focus:border-[#5d89e8]! focus:shadow-[0_0_0_2px_rgb(77_118_197/0.18)]!"
                  classNames={{
