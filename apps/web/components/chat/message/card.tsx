...
export function ChatMessageCard({
  ...
  function handleEditingTextareaKeyDown(
      ...
      >
        <div className="flex w-full max-w-[calc(100%-2.5rem)] flex-col gap-2 sm:max-w-[76%] md:gap-3 lg:max-w-[72%]">
          <div className="flex w-full items-end gap-2 md:gap-3">
            ...
            <div className="min-w-0 flex-1 rounded-xl bg-white py-2 px-3 ring-1 ring-inset ring-(--mst-color-primary) shadow-[0_10px_26px_rgb(22_119_255/0.08)] transition-shadow duration-200 focus-within:shadow-[0_14px_30px_rgb(22_119_255/0.12)] dark:bg-(--mst-color-bg-elevated)">
              <textarea
                aria-label="编辑消息"
      ...
      {shouldUseDrawerEditor ? (
        ...
        >
          <div className="flex h-full min-h-0 flex-col bg-white p-4 dark:bg-(--mst-color-bg-elevated)">
            <div className="min-h-0 flex-1 rounded-[18px] bg-white p-3 ring-1 ring-inset ring-(--mst-color-primary) shadow-[0_10px_26px_rgb(22_119_255/0.08)] dark:bg-(--mst-color-bg-page)">
              <textarea
                aria-label="编辑消息"
