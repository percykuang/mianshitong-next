...
export { AppUiRegistry } from './providers/app-ui-registry'
export { useAppInstance } from './hooks/use-app-instance'
...
export { Descriptions, type DescriptionsProps } from './components/descriptions'
